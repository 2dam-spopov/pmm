...
public class Main3Activity implements Serializable{
    ...
    public Main3Activity(String continente, String nombre, float precio, float peso, String envio, boolean regalo, boolean dedicatoria, int imagen){
    ...
    public String toString(){
        return "Continente: " + this.continente + ". Zona: " + this.nombre + " Peso: " + this.peso  + ". Envio: " + this.envio + ". Regalo: " + this.regalo + ". Dedicatoria: " + this.dedicatoria;
    }
}